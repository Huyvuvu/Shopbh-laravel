        ...
        <div class="row g-4">
            <div class="col-lg-12">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-9">
                        <div id="listSP" class="row g-4 justify-content-center">
                            @foreach($sp as $i)
                            <div class="col-md-6 col-lg-6 col-xl-4">
                                <div class="rounded position-relative fruite-item">
                                    <div class="fruite-img border border-secondary border-bottom-0 rounded-top pt-4">
                                        <a href="/{{$url}}/{{$i->slug}}"><img src="/{{$i->images}}" class="img-fluid w-100 rounded-top" alt="" style="width: 100%;height: 205px;object-fit: cover;object-position: 50% 50%;"></a>
                                    </div>
                                    <div class="p-4 border border-secondary border-top-0 rounded-bottom">
                                        <a href="/{{$url}}/{{$i->slug}}"><h4>{{$i->name}}</h4></a>
                            ...
                            <div class="col-12">
                                <div class="pagination d-flex justify-content-center mt-5">
                                    <a href="/{{$url}}-{{$page - 1}}" class="rounded {{($page == 1)? 'btn disabled': ''}}">&laquo;</a>
                                    @for($i = 1; $i <= $sotrang; $i++)
                                    <a href="/{{$url}}-{{$i}}" class="{{($i == $page)? 'active':''}} rounded">{{$i}}</a>
                                    @endfor
                                    <a href="/{{$url}}-{{$page + 1}}" class="rounded {{($page == $sotrang)? 'btn disabled': ''}}">&raquo;</a>
                                </div>
                            </div>
                        </div>
                    </div>
